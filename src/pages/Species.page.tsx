          ...
          <Group justify="space-between" align="center">
            <Stack gap="xs">
              ...
              <Text size="lg" c="dimmed">
                {selectedSpecies.description?.text || 'Описание отсутствует...'}
              </Text>
            </Stack>
            <Group gap="xs">
              ...
              <Badge color="green" size="xl">
                Скорость: {selectedSpecies.speed} фт.
              </Badge>
            </Group>
          </Group>
      ...
      <Stack gap="xl">
        ...
        <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="sm">
          ...
          <MultiSelect
            ...
            data={uniqueSizes}
            value={
              Array.isArray(sizeFilters)
                ? sizeFilters.filter((v) => typeof v === 'string').map(String)
                : []
            }
            onChange={(values) =>
              setSizeFilters(values ? values.filter((v) => typeof v === 'string') : [])
            }
          />
        </SimpleGrid>
